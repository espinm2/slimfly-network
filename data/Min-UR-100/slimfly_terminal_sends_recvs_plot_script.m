...
% title('Messages Sent Per Terminal')
% colorbar;
% figure
% ribbon(X,Z)
% ylabel('% TW End Time');
...
hidden off;
xlabel('% Time');
ylabel('Compute Node ID');
zlabel('Message Packets Sent');
title('Packets Sent Per Compute Node')
colorbar;
hold off
set(gca, 'FontSize', 14)
...
% title('Messages Received Per Terminal')
% colorbar;
% figure
% ribbon(X,Z)
% ylabel('% TW End Time');
...
xlabel('% Time');
ylabel('Compute Node ID');
zlabel('Message Packets Received');
title('Packets Received Per Compute Node')
colorbar;
hold off
set(gca, 'FontSize', 14)
